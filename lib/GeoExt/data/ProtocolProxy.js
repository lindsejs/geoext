    ...
    loadResponse: function(o, response) {
        if (response.success()) {
            ...
            if (request.status >= 200 && request.status < 300) {
                ...
                this.fireEvent("exception", this, "remote", Ext.data.Api.actions.read, o, response.error, o.records);
            } else {
                // non 200 status
                this.fireEvent("exception", this, "response", Ext.data.Api.actions.read, o, request);
            }
